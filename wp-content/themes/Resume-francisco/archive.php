	...
	<div class="container">
			...
			<div class="cat-search d-flex flex-row flex-wrap justify-content-start align-items-center pb-2 pt-2">
				...
				<ul class='cat-archive flex-wrap'>
					<li><a href="<?php echo esc_url( get_term_link( $category4 ) ); ?>"><?php echo esc_html( $category4->name ); ?></a></li>
					<li><a href="<?php echo esc_url( get_term_link( $category1 ) ); ?>"><?php echo esc_html( $category1->name ); ?></a></li>
					<li><a href="<?php echo esc_url( get_term_link( $category2 ) ); ?>"><?php echo esc_html( $category2->name ); ?></a></li>
					<li><a href="<?php echo esc_url( get_term_link( $category3 ) ); ?>"><?php echo esc_html( $category3->name ); ?></a></li>
				</ul>
			</div>
