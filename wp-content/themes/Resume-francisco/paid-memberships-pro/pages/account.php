...
*/
function pmpro_custom_shortcode_account($atts, $content=null, $code="")
{
...
add_shortcode('pmpro_account', 'pmpro_custom_shortcode_account');



echo pmpro_custom_shortcode_account('');
?>